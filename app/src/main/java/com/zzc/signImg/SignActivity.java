        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (signUtils.addJpgSignatureToGallery(bitmap)) {
                    Toast.makeText(SignActivity.this, "签名保存到图库中", Toast.LENGTH_SHORT).show();
                    finish();
                    Intent intent = new Intent(SignActivity.this, InspectionListActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(SignActivity.this, "无法存储签名", Toast.LENGTH_SHORT).show();
                }
                if (signUtils.addSvgSignatureToGallery(mSignaturePad.getSignatureSvg())) {
                    Toast.makeText(SignActivity.this, "SVG签名保存到库中", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SignActivity.this, "无法存储SVG签名", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
